...
public class FormController {
	...
	@GetMapping("/api/v1/event/{eventId}/form")
	public String create(@PathVariable Long eventId, Model model) {
		model.addAttribute("eventId", eventId);
		return "form/formForm";
	}
	@PostMapping("/api/v1/event/{eventId}/form")
	public String insert(@PathVariable Long eventId, @ModelAttribute FormRequestDto formRequestDto) {
		formRequestDto.setEventId(eventId);
